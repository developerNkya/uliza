...
public class AdapterChat extends RecyclerView.Adapter<com.appsnipp.creativelogindesigns.AdapterChat.Myholder> {
    ...
    public void onBindViewHolder(@NonNull Myholder holder, final int position) {
        ...
        holder.msglayput.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final int clickedPosition = holder.getAdapterPosition(); // Get the current position using getAdapterPosition()
                ...
                builder.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (clickedPosition != RecyclerView.NO_POSITION) {
                            deleteMsg(clickedPosition); // Use the clickedPosition variable here
                        }
                    }
                });
